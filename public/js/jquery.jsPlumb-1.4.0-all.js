    ...
    jsPlumb.AnchorManager = function (params) {
        ...
        var _updateAnchorList = function (lists, theta, order, conn, aBoolean, otherElId, idx, reverse, edgeId, elId, connsToPaint, endpointsToPaint) {
            ...
            if (listToRemoveFrom) {
                ...
                if (rIdx != -1) {
                    ...
                    for (var i = 0; i < listToRemoveFrom.length; i++) {
                        jsPlumbUtil.addWithFunction(connsToPaint, listToRemoveFrom[i][1], function (c) {
            ...
            for (var i = 0; i < listToAddTo.length; i++) {
                ...
                jsPlumbUtil.addWithFunction(connsToPaint, listToAddTo[i][1], function (c) {
            ...
            if (!jsPlumbInstance.isSuspendDrawing()) {
                ...
                for (var i = 0; i < ep.length; i++) {
                    if (ep[i].connections.length == 0 && ep[i].anchor.isContinuous) {
                        ...
                        }, false, elementId, 0, false, "top", elementId, connectionsToPaint, endpointsToPaint)
...
// ********************************* OVERLAY DEFINITIONS ***********************************************************************
    ...
    jsPlumb.Overlays.Arrow = function (params) {
        ...
        this.cleanup = function () {
        };  // nothing to clean up for Arrows
    ...
    jsPlumb.Overlays.GuideLines = function () {
        ...
        this.cleanup = function () {
        };  // nothing to clean up for GuideLines
    };
